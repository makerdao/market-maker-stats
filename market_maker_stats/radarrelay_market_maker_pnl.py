...
from market_maker_stats.radarrelay import radarrelay_trades
from market_maker_stats.util import get_block_timestamp, sort_trades_for_pnl, get_gdax_prices
from pymaker import Address
from pymaker.zrx import ZrxExchange


class RadarRelayMarketMakerPnl:
    """Tool to calculate profitability for the RadarRelay market maker keeper."""

    def __init__(self, args: list):
        parser = argparse.ArgumentParser(prog='radarrelay-market-maker-pnl')
...
if __name__ == '__main__':
    RadarRelayMarketMakerPnl(sys.argv[1:]).main()
