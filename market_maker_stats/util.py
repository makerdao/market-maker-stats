...
def amount_to_size(trade: AllTrade):
    ...
    if trade.pair.startswith("DAI-"):
        amount_in_usd = trade.amount
    elif trade.pair.endswith("-DAI"):
